...
class Preprocessor:
    ...
    def remove_unused_columns(self, data):
        """
                Method Name: remove_unused_columns
                Description : This method removes unwanted columns  from the dataframe.
        ...
        """
        return self.remove_columns(data,['Genotype','Treatment','Behavior']) 
